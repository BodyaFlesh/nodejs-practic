...
describe('Listing Users', () => {
  ...
  it('returs 2 as totalPages when thre are 15 active and 7 inactive users', async () => {
    await addUsers(15, 7);
  ...
  it('returns 5 users and corresponding size indicztor when size is set as 5 in request parametr', async () => {
    await addUsers(11);
