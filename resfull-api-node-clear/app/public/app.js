    ...
    if (phone) {
        ...
        app.client.request(undefined, "api/users", "GET", queryStringObject, undefined, function(statusCode, responsePayload) {
            if (statusCode == 200) {
                ...
                var allChecks =
                    typeof responsePayload.checks == "object" && responsePayload.checks instanceof Array && responsePayload.checks.length > 0
...
app.loadChecksEditPage = function() {
    ...
    var id =
        typeof window.location.href.split("=")[1] == "string" && window.location.href.split("=")[1].length > 0 ? window.location.href.split("=")[1] : false;
    if (id) {
